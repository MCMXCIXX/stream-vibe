...
const Slider = (props) => {
    ...
    return (
        <div className={classNames('slider', {"slider--isBeyondTheVieportOnMobileS" : isBeyondTheVieportOnMobileS})}
            ...
            {hasScrollbar && (
                <div className="slider__scrollbar visible-mobile" data-js-slider-scrollbar />
            )}
        </div>
    )
}
